...
#ifdef _X86_
// static_assert(sizeof(BOOT_GRAPHICS_CONTEXT_V3) == 0x150, "BOOT_GRAPHICS_CONTEXT_V3 has incorrect size.");
...
// static_assert(offsetof(BOOT_GRAPHICS_CONTEXT_V3, unk17) == 0xa4, "BOOT_GRAPHICS_CONTEXT_V3 unk17");
// static_assert(offsetof(BOOT_GRAPHICS_CONTEXT_V3, unk18) == 0xa8, "BOOT_GRAPHICS_CONTEXT_V3 unk18");
// static_assert(offsetof(BOOT_GRAPHICS_CONTEXT_V3, block2.unk19) == 0xac, "BOOT_GRAPHICS_CONTEXT_V3 unk19");
// static_assert(offsetof(BOOT_GRAPHICS_CONTEXT_V3, block2.reserve_pool) == 0xb0, "BOOT_GRAPHICS_CONTEXT_V3 reserve_pool");
// static_assert(offsetof(BOOT_GRAPHICS_CONTEXT_V3, block2.reserve_pool_size) == 0xb4, "BOOT_GRAPHICS_CONTEXT_V3 reserve_pool_size");
// static_assert(offsetof(BOOT_GRAPHICS_CONTEXT_V3, block2.string_resources) == 0xb8, "BOOT_GRAPHICS_CONTEXT_V3 string_resources");
// static_assert(offsetof(BOOT_GRAPHICS_CONTEXT_V3, block2.progress_resources) == 0xbc, "BOOT_GRAPHICS_CONTEXT_V3 progress_resources");
// static_assert(offsetof(BOOT_GRAPHICS_CONTEXT_V3, edid) == 0xc0, "BOOT_GRAPHICS_CONTEXT_V3 edid");
// static_assert(offsetof(BOOT_GRAPHICS_CONTEXT_V3, unk20) == 0x140, "BOOT_GRAPHICS_CONTEXT_V3 unk20");
// static_assert(offsetof(BOOT_GRAPHICS_CONTEXT_V3, unk21) == 0x144, "BOOT_GRAPHICS_CONTEXT_V3 unk21");
// static_assert(offsetof(BOOT_GRAPHICS_CONTEXT_V3, unk22) == 0x148, "BOOT_GRAPHICS_CONTEXT_V3 unk22");
// static_assert(offsetof(BOOT_GRAPHICS_CONTEXT_V3, unk23) == 0x14c, "BOOT_GRAPHICS_CONTEXT_V3 unk23");
#elif defined(__x86_64__)
